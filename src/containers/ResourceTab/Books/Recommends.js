...
import {userActions, resourceActions} from 'Redux/actions';
import {dySize} from 'utils/responsive';

class SelectRecommendMemberScreen extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      searchText: '',
  ...
  onChangeSearchText = text => {
    ...
    this.searchTrustMembers(text);
  };

  searchTrustMembers = _.debounce(text => {
    this.props.getTrustMembers({
      status: 1,
      name: text,
      page: 1,
...
const mapDispatchToProps = {
  ...
  recommendResourceToMembers: resourceActions.recommendResourceToMembers,
};
