...
export const SET_TOOLS_DRAWER_OPENED = 'SET_TOOLS_DRAWER_OPENED';
...
export const SET_SUPPORTED_HABIT_USER = 'SET_SUPPORTED_HABIT_USER';
export const SET_SUPPORTED_HABIT_OWNERS = 'SET_SUPPORTED_HABIT_OWNERS';
...
export const GET_OWNERS_WITH_RESOURCE_PERMISSION =
  'GET_OWNERS_WITH_RESOURCE_PERMISSION';
export const ADD_OWNERS_WITH_RESOURCE_PERMISSION =
  'ADD_OWNERS_WITH_RESOURCE_PERMISSION';
export const SET_SEARCHED_OWNERS_WITH_RESOURCE_PERMISSION =
  'SET_SEARCHED_OWNERS_WITH_RESOURCE_PERMISSION';
export const SET_OWNERS_WITH_RESOURCE_PERMISSION_PAGE_LIMITED =
  'SET_OWNERS_WITH_RESOURCE_PERMISSION_PAGE_LIMITED';
export const SET_SEARCH_OWNERS_WITH_RESOURCE_PERMISSION_INDEX =
  'SET_SEARCH_OWNERS_WITH_RESOURCE_PERMISSION_INDEX';
export const SET_OWNERS_WITH_RESOURCE_PERMISSION_STATE =
  'SET_OWNERS_WITH_RESOURCE_PERMISSION_STATE';
...
export const GET_SELECTED_MEMBER_RESOURCES = 'GET_SELECTED_MEMBER_RESOURCES';
export const ADD_MEMBER_RESOURCES = 'ADD_MEMBER_RESOURCES';
export const SET_SEARCHED_MEMBER_RESOURCES = 'SET_SEARCHED_MEMBER_RESOURCES';
export const SET_MEMBER_RESOURCE_PAGE_LIMITED =
  'SET_MEMBER_RESOURCE_PAGE_LIMITED';
export const SET_MEMBER_RESOURCE_STATE = 'SET_MEMBER_RESOURCE_STATE';
export const SET_MEMBER_RESOURCE_PAGE_INDEX = 'SET_MEMBER_RESOURCE_PAGE_INDEX';
export const SELECT_MEMBER = 'SELECT_MEMBER';
export const RESET_MEMBER_RESOURCES = 'RESET_MEMBER_RESOURCES';
...
export const GET_RECOMMENDED_OWNERS = 'GET_RECOMMENDED_OWNERS';
export const ADD_RECOMMENDED_OWNERS = 'ADD_RECOMMENDED_OWNERS';
export const SET_SEARCHED_RECOMMENDED_OWNERS =
  'SET_SEARCHED_RECOMMENDED_OWNERS';
export const SET_RECOMMENDED_OWNERS_PAGE_LIMITED =
  'SET_RECOMMENDED_OWNERS_PAGE_LIMITED';
export const SET_RECOMMENDED_OWNERS_STATE = 'SET_RECOMMENDED_OWNERS_STATE';
export const SET_RECOMMENDED_OWNERS_PAGE_INDEX =
  'SET_RECOMMENDED_OWNERS_PAGE_INDEX';

export const REMOVE_RECOMMENDED_RESOURCE = 'REMOVE_RECOMMENDED_RESOURCE';
export const HIDDEN_RECOMMENDED_RESOURCE = 'HIDDEN_RECOMMENDED_RESOURCE';
...
export const GET_POST_TRUST_MEMBERS = 'GET_POST_TRUST_MEMBERS';
export const SET_POST_TRUST_MEMBERS = 'SET_POST_TRUST_MEMBERS';
export const ADD_POST_TRUST_MEMBERS = 'ADD_POST_TRUST_MEMBERS';

// Challenge
export const SELECT_CHALLENGE = 'SELECT_CHALLENGE';
export const FOCUS_CHALLENGE = 'FOCUS_CHALLENGE';
export const UPDATE_SELECTED_CHALLENGE = 'UPDATE_SELECTED_CHALLENGE';
export const UPDATE_FOCUSED_CHALLENGE = 'UPDATE_FOCUSED_CHALLENGE';
export const SET_TEAMMATES_LOADING_STATE = 'SET_TEAMMATES_LOADING_STATE';
export const GET_AVAILBLE_TEAMMATES = 'GET_AVAILBLE_TEAMMATES';
export const SET_AVAILBLE_TEAMMATES = 'SET_AVAILBLE_TEAMMATES';
export const ADD_AVAILBLE_TEAMMATES = 'ADD_AVAILBLE_TEAMMATES';
export const SET_TEAMMATES_PAGE_INDEX = 'SET_TEAMMATES_PAGE_INDEX';
export const SET_TEAMMATES_PAGE_LIMITED = 'SET_TEAMMATES_PAGE_LIMITED';
export const ADD_OR_UPDATE_CHALLENGE = 'ADD_OR_UPDATE_CHALLENGE';
export const SET_MY_CHALLENGES = 'SET_MY_CHALLENGES';
...
export const SET_CHALLENGE_RESET_TIME = 'SET_CHALLENGE_RESET_TIME';
export const RESET_MY_CHALLENGES = 'RESET_MY_CHALLENGES';
